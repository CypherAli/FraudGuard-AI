# start-server.ps1 - Start FraudGuard-AI backend server
...
$apiDir = Join-Path $projectRoot "services\api-gateway"
...
if ($lanIP) {
    ...
    $lanIP = "192.168.1.234"
    Write-Host "  [WARNING] Could not detect LAN IP, using default: $lanIP" -ForegroundColor Yellow
}
