...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Google.Android.Play.Core.Listener.IStateUpdatedListenerImplementor, Xamarin.Google.Android.Play.Core.Common", StateUpdatedListenerImplementor.class, __md_methods);
	}
	...
	public StateUpdatedListenerImplementor ()
	{
		...
		if (getClass () == StateUpdatedListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Xamarin.Google.Android.Play.Core.Listener.IStateUpdatedListenerImplementor, Xamarin.Google.Android.Play.Core.Common", "", this, new java.lang.Object[] {  });
		}
	}
