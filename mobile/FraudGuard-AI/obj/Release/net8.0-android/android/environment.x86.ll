...
@dso_cache = dso_local local_unnamed_addr global [636 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 283163990, ; hash 0x10e0bd56, from name: Plugin.AudioRecorder.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 367216257, ; hash 0x15e34681, from name: Plugin.AudioRecorder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.AudioRecorder.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	...
	%struct.DSOCacheEntry {
		i64 412943193, ; hash 0x189d0359, from name: aot-FraudGuardAI.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 551495899, ; hash 0x20df28db, from name: libaot-FraudGuardAI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FraudGuardAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	...
	%struct.DSOCacheEntry {
		i64 1005247442, ; hash 0x3beadbd2, from name: FraudGuardAI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FraudGuardAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 140
	...
	%struct.DSOCacheEntry {
		i64 1383042059, ; hash 0x526f8c0b, from name: aot-Plugin.AudioRecorder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.AudioRecorder.dll.so
		ptr null; void* handle (0x0)
	}, ; 196
	...
	%struct.DSOCacheEntry {
		i64 1593325549, ; hash 0x5ef837ed, from name: FraudGuardAI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FraudGuardAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 2182436920, ; hash 0x82155838, from name: libaot-Plugin.AudioRecorder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.AudioRecorder.dll.so
		ptr null; void* handle (0x0)
	}, ; 307
	...
	%struct.DSOCacheEntry {
		i64 2527890871, ; hash 0x96ac8db7, from name: aot-Plugin.AudioRecorder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.AudioRecorder.dll.so
		ptr null; void* handle (0x0)
	}, ; 361
	...
	%struct.DSOCacheEntry {
		i64 3322992765, ; hash 0xc610d87d, from name: libaot-FraudGuardAI.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FraudGuardAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 503
	...
	%struct.DSOCacheEntry {
		i64 3538790266, ; hash 0xd2eda77a, from name: aot-FraudGuardAI
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FraudGuardAI.dll.so
		ptr null; void* handle (0x0)
	}, ; 531
	...
	%struct.DSOCacheEntry {
		i64 4067006030, ; hash 0xf269964e, from name: libaot-Plugin.AudioRecorder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-Plugin.AudioRecorder.dll.so
		ptr null; void* handle (0x0)
	}, ; 605
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [136 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
